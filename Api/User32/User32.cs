...
namespace ManagedWin32.Api
{
    public static class User32
    {
        ...
        /// </summary>
        [DllImport(DllName, EntryPoint = "CreateWindowExW", SetLastError = true)]
        ...
        /// </summary>
        [DllImport(DllName, EntryPoint = "RegisterClassW", SetLastError = true)]
        ...
        /// <returns></returns>
        [DllImport(DllName, EntryPoint = "RegisterWindowMessageW")]
        public static extern uint RegisterWindowMessage([MarshalAs(UnmanagedType.LPWStr)] string lpString);

        [DllImport(DllName, CharSet = CharSet.None, ExactSpelling = true, SetLastError = true)]
